                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-6 text-right">
                                <a href="pages/kebutuhan/tambah-vaksin.php" class="btn mb-1 btn-primary">Tambah <span class="btn-icon-right"><i class="fa fa-plus"></i></span></a>
                            </div>
                        </div>
                                            ...
                                            <div class="dropdown-button">
                                                <div class="text-center" role="group">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        <a class="dropdown-item" href="pages/kebutuhan/edit-vaksin.php"><i class="far fa-edit"></i> Edit</a>
